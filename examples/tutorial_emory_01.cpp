//                       Poisson Equation
//
// This example is part of the MFEM tutorial for the MATH572 Emory course.
...
//
// Compile with: make tutorial_emory_01
//
// Sample runs:  mpirun -np 4 tutorial_emory_01 -m ../data/square-disc.mesh
//               mpirun -np 4 tutorial_emory_01 -m ../data/star.mesh
//               mpirun -np 4 tutorial_emory_01 -m ../data/star-mixed.mesh
//               mpirun -np 4 tutorial_emory_01 -m ../data/escher.mesh
//               mpirun -np 4 tutorial_emory_01 -m ../data/fichera.mesh
//               mpirun -np 4 tutorial_emory_01 -m ../data/fichera-mixed.mesh
//               mpirun -np 4 tutorial_emory_01 -m ../data/toroid-wedge.mesh
//               mpirun -np 4 tutorial_emory_01 -m ../data/octahedron.mesh -o 1
//               mpirun -np 4 tutorial_emory_01 -m ../data/periodic-annulus-sector.msh
//               mpirun -np 4 tutorial_emory_01 -m ../data/periodic-torus-sector.msh
//               mpirun -np 4 tutorial_emory_01 -m ../data/square-disc-p2.vtk -o 2
//               mpirun -np 4 tutorial_emory_01 -m ../data/square-disc-p3.mesh -o 3
//               mpirun -np 4 tutorial_emory_01 -m ../data/square-disc-nurbs.mesh
//               mpirun -np 4 tutorial_emory_01 -m ../data/star-mixed-p2.mesh -o 2
//               mpirun -np 4 tutorial_emory_01 -m ../data/disc-nurbs.mesh 
//               mpirun -np 4 tutorial_emory_01 -m ../data/pipe-nurbs.mesh
//               mpirun -np 4 tutorial_emory_01 -m ../data/ball-nurbs.mesh -o 2
//               mpirun -np 4 tutorial_emory_01 -m ../data/fichera-mixed-p2.mesh -o 2
//               mpirun -np 4 tutorial_emory_01 -m ../data/star-surf.mesh
//               mpirun -np 4 tutorial_emory_01 -m ../data/square-disc-surf.mesh
//               mpirun -np 4 tutorial_emory_01 -m ../data/inline-segment.mesh
//               mpirun -np 4 tutorial_emory_01 -m ../data/amr-quad.mesh
//               mpirun -np 4 tutorial_emory_01 -m ../data/amr-hex.mesh
//               mpirun -np 4 tutorial_emory_01 -m ../data/mobius-strip.mesh
//               mpirun -np 4 tutorial_emory_01 -m ../data/mobius-strip.mesh
//
