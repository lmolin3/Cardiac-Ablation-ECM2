...
//
// Description:  This example code is based on tutorial_emory_01.cpp serves to run
...
//               mpirun -np 4 tutorial_emory_01_convergence -rs 3 -o 1
//
// 2. Convergence study on cubic finite elements (should observe rate ~4 in L2 and ~3 in H1):
//               mpirun -np 4 tutorial_emory_01_convergence -rs 3 -o 3
//
// 3. Modified frequency for the exact solution (default is freq=2.0):
//               mpirun -np 4 tutorial_emory_01_convergence -rs 3 -o 2 -k 4.0
//
