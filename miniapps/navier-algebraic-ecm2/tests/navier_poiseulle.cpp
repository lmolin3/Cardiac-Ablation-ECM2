...
// mpirun -np 4 ./navier-poiseulle -d 2 -rs 0 -ou 2 -op 1 -dt 1e-3 -tf 1e-1 -kv 1.0 -dp 1.0 --splitting 1
// 2. Chorin-Temam splitting
// mpirun -np 4 ./navier-poiseulle -d 2 -rs 0 -ou 2 -op 1 -dt 1e-3 -tf 1e-1 -kv 1.0 -dp 1.0 --splitting 0
// 3. Different preconditioner (0-4, see details below)
// mpirun -np 4 ./navier-poiseulle -d 2 -rs 0 -ou 2 -op 1 -dt 1e-3 -tf 1e-1 -kv 1.0 -dp 1.0 --splitting 1 --preconditioner 3
