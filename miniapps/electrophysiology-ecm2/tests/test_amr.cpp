...
//
// 2D example:
//   mpirun -np 8 ./test_amr -d 2 -tf 200 -mt 1 -o 2 -rs 0 -dt 0.1 -sf 1 -of ./Output/AMR \
//                           --amr --nc-limit 4 --max-err 5e-2
//
// GPU:
//   ./test_amr -d 2 -tf 200 -mt 1 -o 2 -rs 0 -dt 0.1 -sf 1 -dev cuda -of ./Output/AMR \
//              --amr --nc-limit 4 --max-err 5e-2
//
//
