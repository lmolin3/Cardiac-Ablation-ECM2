...
public:
   ...
   LumpedVectorMassIntegrator()
      : VectorMassIntegrator(), diag(0.0), M_lump(0.0), M_tot(0.0), mcoeff(0.0), vec(0.0), Q_order(0) {};
   ...
   LumpedVectorMassIntegrator(Coefficient &q, int qo = 0)
      : VectorMassIntegrator(q, qo),  diag(0.0), M_lump(0.0), M_tot(0.0), mcoeff(0.0), vec(0.0), Q_order(0)  {};

   LumpedVectorMassIntegrator(Coefficient &q, const IntegrationRule *ir)
      : VectorMassIntegrator(q, ir), diag(0.0), M_lump(0.0), M_tot(0.0), mcoeff(0.0), vec(0.0), Q_order(0)  {};
