...
#include "../../linalg/dtensor.hpp" // required for Reshape
...
namespace mfem
{
    ...
    namespace ecm2_utils
    {
        ...
        {
        public:
            RobinCoeffContainer(Array<int> attr, Coefficient *h_coeff, Coefficient *T0_coeff)
                : attr(attr), h_coeff(h_coeff), T0_coeff(T0_coeff)
            {
