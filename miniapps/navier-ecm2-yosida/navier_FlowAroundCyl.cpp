...
//
// Run with:
// mpirun -np 4 ./navier_ecm2_flowaroundcyl -d 2 -rs 0 -rp 0 -ou 2 -op 1 -dt 1e-3 -tf 1e-1 -tp 1e-2 -kv 1.0 -re 100 --gamma 1.0 --verbose --paraview --output-folder ./Output/FlowAroundCyl/2D/Test
//
