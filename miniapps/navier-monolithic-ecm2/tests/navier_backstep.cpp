...
struct s_NavierContext // Navier Stokes params
{
   ...
   int schur_pc_type = 1; // 0: Pressure Mass, 1: Pressure Laplacian, 2: PCD, 3: Cahouet-Chabard, 4: LCS, 5: Approximate Inverse   int correction_order = 1; // Correction order for High-Order Yosida
} NS_ctx;
