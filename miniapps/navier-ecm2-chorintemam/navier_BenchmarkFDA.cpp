...
//
// Run with:
// mpirun -np 4 ./navier_ecm2_benchmarkFDA -d 2 -rs 0 -rp 0 -ou 2 -op 1 -dt 1e-3 -tf 1e-1 -tp 1e-2 -u 1.0 --gamma 1.0 --verbose --paraview --output-folder ./Output/BenchmarkFDA/2D/Test
//
...
int main(int argc, char *argv[])
{
   ...
   args.AddOption(&NS_ctx.Umax, "-u", "--inlet-velocity", "Inlet Velocity.");
