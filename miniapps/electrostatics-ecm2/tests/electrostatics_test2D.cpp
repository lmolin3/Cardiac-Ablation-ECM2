...
// Sample runs:
//
//   1. A cylinder at constant RF_solverge in a square, grounded metal pipe:
//      mpirun -np 4 electrostatics_test2D -m ../../data/square-disc.mesh -rs 4 -o 4 -sattr '1' -sval '1.0' -dbcs '6 8' -dbcv '0.0  1.0' -prec 1
//
//   2. Example with beam-quad mesh (to test pa in 2D)
//      mpirun -np 4 electrostatics_test2D -m ../../data/beam-quad.mesh -rs 5 -o 7 -sattr '1 2' -sval '1.0 1.0' -dbcs '1 2' -dbcv '1.0  0.0' -pa -prec 1
//
//   3. Example with beam-quad mesh (to test pa in 2D, and CUDA backend)
//      ./electrostatics_test2D -m ../../data/beam-quad.mesh -rs 5 -o 7 -sattr '1 2' -sval '1.0 1.0' -dbcs '1 2' -dbcv '1.0  0.0' -pa -prec 1 -d cuda
//
